...
//
// Fork-isolated patcher for the mcode-hub status line.
//
...
const log = (m) => process.stderr.write(`[mcode-hub] ${m}\n`);
...
// Sidecar body
// ============================================================================
const SIDECAR_BODY = `// mcode-hub sidecar — generated by mcode-patch-quota.mjs. DO NOT EDIT.
//
...
// ============================================================================
const CLI_MARKER = "mcode-hub-sidecar";
...
function main() {
  ...
  if (sidecarChanged) {
    // Write-then-rename: concurrent `mcode-hub` launches must never let one
