...
```
会话 tokens 267K 「输入 20K │ 输出 2K │ 缓存 245K」  │  上下文 25K/512K 5%  │  缓存命中 98%  │  轮数 54
...
```
会话 tokens 267K 「输入 20K │ 输出 2K │ 缓存 245K」  │  上下文 25K/512K 5%  │  缓存命中 98%
...
```
会话 tokens 274M  │  上下文 25K/512K 5%  │  缓存命中 98%  │  轮数 54
小时会话窗口 [██████████████████░] 90% 剩余  │ 重置 3h 42m
周限制使用量 [████████████████░░░░] 82% 剩余  │ 重置 4d 12h
```
...
```
会话 tokens 274M  │  上下文 25K/512K 5%  │  轮数 54
小时会话窗口 [██████████████░░] 90% 剩余  │ 重置 3h 42m
周限制使用量 [█████████████░░░] 82% 剩余  │ 重置 4d 12h
```
